...
//         *self.kern_pt.lock() = Some(KernPageTable::new());
//         let kern_pt_addr = self.kern_pt.lock().as_mut().unwrap().get_baddr().as_usize();
...
//             panic!("Locks held before MMU initialization");
//         }
...
//             Some(ref KPT) => KPT.get_baddr(),
//             None => { panic!("VMM should be initialized"); }
//         }
//     }
// }