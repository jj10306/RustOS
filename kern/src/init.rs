...
//         // set up exception handlers
//         // FIXME: load `vectors` addr into appropriate register (guide: 10.4)
//         VBAR_EL1.set((&mut vectors) as *const u64 as u64);
...
//         write_volatile(SPINNING_BASE.add(core_idx), start2 as usize);
//         sev();
//         while read_volatile(SPINNING_BASE.add(core_idx)) != 0 {}
//     }
// }
